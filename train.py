...
dataset = LightningMarmotDataset(
    data_dir="./data/Marmot_data/",
    train_augmentation=train_transform,
    test_processing=test_transform,
    batch_size=1,
)
...
checkpoint_callback = ModelCheckpoint(
    monitor="val_loss", save_top_k=1, save_last=True, mode="min"
)
...
trainer = pl.Trainer(
    ...
    logger=TensorBoardLogger(
        "lightning_tablenet", name="tablenet_baseline_adam_gradclipping"
    ),
    max_epochs=5000,
